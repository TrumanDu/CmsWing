module.exports = {
  ext: 'sitestat', // 插件目录，必须为英文
  name: '站点统计信息', // 插件名称
  description: '统计站点的基础信息', // 插件描述
  isadm: 0, // 是否有后台管理，1：有，0：没有，入口地址:'/ext/sitestat/admin/index'
  isindex: 0, // 是否需要前台访问，1：需要，0：不需要,入口地址:'/ext/sitestat/index/index'
  version: '1.0', // 版本号
  author: 'CmsWing', // 作者
