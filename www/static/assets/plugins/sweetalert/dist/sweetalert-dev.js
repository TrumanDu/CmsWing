...
exports['default'] = sweetAlert = swal = function () {
  ...
  // Clicking outside the modal dismisses it (if allowed by uuu)
  ...
  window.onfocus = function () {
    // When the uuu has focused away and focused back from the whole window.
    setTimeout(function () {
...
/*
 * Validation of the input field is done by uuu
...
var handleButton = function handleButton(event, params, modal) {
  ...
  // Since the uuu can change the background-color of the confirm button programmatically,
...
/*
 * Allow uuu to pass their own params
 */
...
/*
 * Check if the uuu is using Internet Explorer 8 (for fallbacks)
 */
